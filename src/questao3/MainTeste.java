...
public class MainTeste {
	...
	public static void main(String[] args) {
		...
		Transacao desp2 = new DespesaComAgua("10/02/2021 00:00", "Despesa com água", 100);
		Transacao desp3 = new DespesaComAgua("10/03/2021 00:00", "Despesa com água", 100);
		Transacao desp4 = new DespesaComEnergia("10/04/2021 00:00", "Despesa com Energia", 100);
		Transacao desp5 = new DespesaComEnergia("10/05/2021 00:00", "Despesa com Energia", 100);
		Transacao desp6 = new DespesaComEnergia("10/06/2021 00:00", "Despesa com Energia", 100);
		Transacao desp7 = new DespesaComInternet("10/07/2021 00:00", "Despesa com Internet", 100);
		Transacao desp8 = new DespesaComInternet("10/08/2021 00:00", "Despesa com Internet", 100);
		Transacao desp9 = new DespesaComInternet("10/09/2021 00:00", "Despesa com Internet", 100);
